...
def read_UCF101_OP(data_folder):
  ...
  ucf101_op_data = {}
  ucf101_op_data["train_img"] = train_img - mean_img
  ucf101_op_data["test_img"] = test_img - mean_img
  ucf101_op_data["train_label"] = train_label
  ucf101_op_data["test_label"] = test_label

  return ucf101_op_data
